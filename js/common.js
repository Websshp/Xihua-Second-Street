...
function ajaxWant(){
	$.ajax({
			    ...
			    success:function(data){
			    	if (data=='1') {
			    		alert("发布成功");
			    		window.location.href="http://localhost/xihua%20Second%20hand%20Street/php/want.php";
			    	}
			    	else{
			    		alert("发布失败");
			    	}
		...
		$.ajax({
			    ...
			    success:function(data){
			    	if (data=='0') {
			    		...
			    		window.location='http://localhost/xihua%20Second%20hand%20Street/fabushangping.html';
			    	}
			    },
			    error:function(XMLHttpRequest, textStatus, errorThrown) {
                        alert("请求失败!");
		...
		$.ajax({
			    ...
			    success:function(data){
			    	if (data=='0') {
			    		...
			    		window.location='http://localhost/xihua%20Second%20hand%20Street/php/want.php';
			    		}
			    },
			    error:function(XMLHttpRequest, textStatus, errorThrown) {
                        alert("请求失败!");
...
function showgoods(){
	$('.Goods').bind("click",function(event){
		...
		$.ajax({
				...
				type:'POST',
			    success:function(data){
			    	 window.open("http://localhost/xihua%20Second%20hand%20Street/php/goods.php");
			    },
			    error:function(XMLHttpRequest, textStatus, errorThrown) {
                        alert("请求失败!");
                    }
